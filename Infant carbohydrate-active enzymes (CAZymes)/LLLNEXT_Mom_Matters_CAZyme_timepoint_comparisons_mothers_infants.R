...
cazymes_clean <- Prepare_cazymes(
  File = "/Users/trishlasinha/Desktop/LLNEXT/Analysis/cazymes/NEXT_cayman_all_17_03_2025.txt",
  Prevalence_min = 0,
  Transform = "log"
)
...
ggsave(
  "~/Desktop/LLNEXT/Analysis/results/figures/supplementary/ED_5c.pdf",
  plot = overall_timepoint,
  width = 6,
  height = 6,
  units = "in"
)

# Source data for CAZyme PCoA plots
source_data_CAZyme_PCoA <- phenos_pc_CLR %>%
...
write.table(
  source_data_CAZyme_PCoA,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_ED_5_c_pcoa_cazymes.txt",
  sep = "\t",
  row.names = FALSE
)
...
# Save source data for Extended Data Fig. 5d
source_data_ED5d <- filtered_all_wide 

write.csv(
  source_data_ED5d,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/Source_Data_ED_5d_cazyme_infant_timepoints.csv",
  row.names = FALSE
)
