...
# This script gives the code for Main Figure 3 and related supplementary tables 
...
write.table(source_data_fig_3_a, "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_fig_3_a_bacteroides.txt", sep="\t", row.names = F)
...
source_data_fig_3_b <- data.frame(
  Feature = rownames(heatmap_data),
...
write.table(
  source_data_fig_3_b,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/Source_data_Figure3b.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
...
source_data_fig_3_c <- data.frame(
  Feature = rownames(heatmap_data),
  as.data.frame(heatmap_data),
  check.names = FALSE
)
...
write.table(
  source_data_fig_3_c,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_fig_3_c_feeding.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
...
source_data_fig_3_d<-clean_data[,c("Timepoint_categorical", "infant_ffq_feeding_mode_simple", "MGB043")]

write.table(
  source_data_fig_3_d,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_fig_3_d_feeding_acetate.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
...
source_data_fig_3_e<-significant

write.table(
  source_data_fig_3_e,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_fig_3_e_cazymes_bac.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
...
sig_timepoint_enrichment<-all_timepoint_enrichment[all_timepoint_enrichment$FDR<0.05,]
...
source_data_fig_3_f<-sig_timepoint_enrichment

write.table(
  source_data_fig_3_f,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/source_data_fig_3_f_substrate_enrichment.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
