...
# Scripts related to the association of cazymes with bacteria in infants and mothers 
...
# Source data for mother CAZyme–taxa PERMANOVA figure
source_data_mothers_5e <- significant %>%
  dplyr::select(
    Timepoint,
    Taxon,
    R2,
  ...
  dplyr::arrange(Taxon, Timepoint)

write.csv(
  source_data_mothers_5e,
  "/Users/trishlasinha/Desktop/LLNEXT/Analysis/submission_Nature_post_acceptance_2026/Source_data/Source_Data_CAZyme_taxa_mothers.csv",
  row.names = FALSE
)
