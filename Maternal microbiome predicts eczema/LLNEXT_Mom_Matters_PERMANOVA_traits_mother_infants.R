...
infant_taxa_all_filt <- infant_taxa_all[, unique_counts >= 0.1*length(unique(infant_taxa_all$next_id_infant)) ] # Setting a 10% cut-off on prevalence 
...
mother_taxa_all_filt <- mother_taxa_all[, unique_counts >= 0.3*length(unique(mother_taxa_all$next_id_mother)) ] # Setting a 30% cut-off on prevalence 
